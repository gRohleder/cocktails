package de.gerdrohleder.cocktails.views.cocktailiste;
...
@Route(value = "all", layout = MainView.class)
@PageTitle("Cocktailiste")
@CssImport("./styles/views/cocktailiste/cocktailiste-view.css")
