package de.gerdrohleder.cocktails.views.main;
...
@PWA(name = "cocktails", shortName = "cocktails", enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "cocktails logo"));
        logoLayout.add(new H1("cocktails"));
