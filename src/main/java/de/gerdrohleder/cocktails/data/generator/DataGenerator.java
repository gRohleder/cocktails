...
public class DataGenerator {
    ...
    public CommandLineRunner loadIngredientData(IngredientRepository repository) {
        return args -> {
            ...
            repository.save(Ingredient.builder().zname("Gin").build());
            repository.save(Ingredient.builder().zname("Blue Curacao").build());
            repository.save(Ingredient.builder().zname("Zitronenlimonade").build());
